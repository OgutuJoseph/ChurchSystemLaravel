                        ...
                        @endif
                            <form method="POST" action="{{ route('custom.register') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="control-label col-md-3 text-left">Date of Birth
								            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Church Group</label>
                                            <select class="form-control" name="group_id" required>
                                                <option value="">Select Church Group</option>
                                                @foreach($church_groups as $church_group)
                                                    <option value="{{ $church_group->group_id }}">{{ $church_group->group_name }}</option>
                                                 @endforeach
                                            </select>                                       
                                         </div>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <a href="/member/login" class="btn btn-success">Login</a>
                                </div>
                            </form>
                        </div>
                    </div>
